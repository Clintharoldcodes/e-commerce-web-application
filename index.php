...
<head>
    ...
    <style>
        ...
        .wrapper {
            ...
            border-radius: 8px;
            box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.5); /* Black glow for contrast */
            margin: auto;
            margin-top: 100px;
        }
        h2, p {
        ...
        .form-control {
            ...
            border: 1px solid #ffffff; /* White border for better contrast */
        }
        .form-control:focus {
            border-color: #ffffff;
            box-shadow: 0 0 8px rgba(255, 255, 255, 0.5); /* White focus glow */
        }
        .btn-primary {
        ...
        .alert-danger {
            background-color: #333333; /* Dark alert box */
            color: #ffffff;
            border: none;
        }
        a {
